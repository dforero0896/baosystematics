...
\begin{frame}[allowframebreaks]{Introduction}
	\begin{columns}
		\begin{column}{0.55\linewidth}
				...
				%\begin{figure}
				%	\centering
				%	\includegraphics[width=0.5\linewidth]{../../Bibliography/doc_pics/borexinoview}
				%	\caption{\small Borexino. Taken from \parencite{Ludhova2013}.}
				%	\label{fig:borexinoview}
				%\end{figure}
...
\begin{frame}[allowframebreaks]{Catalog generation}
	...
	\item Use \textsc{Dive} to extract void catalogs with 
...
\end{columns}
\end{frame}
\begin{frame}[allowframebreaks]{Results: Mean 2PCF}
\begin{figure}
	\centering
	\includegraphics[width=0.4\linewidth]{plots/TwoPCF_mockavg_nosyst_v7_gal_cbz_triplot}
	\includegraphics[width=0.4\linewidth]{plots/TwoPCF_mockavg_allsyst_v7_gal_cbz_triplot}
...
\begin{figure}
	\centering
	\includegraphics[width=0.4\linewidth]{plots/{{TwoPCF_mockavg_nosyst_v7_void_R-15.5-50_cbz_triplot}}}
	\includegraphics[width=0.4\linewidth]{plots/{{TwoPCF_mockavg_allsyst_v7_void_R-15.5-50_cbz_triplot}}}
...
\begin{figure}
	...
	\caption{Best fit curves for galaxy tracers with (right) and without (left) systematics. Shaded region shows the $1\sigma$ band obtained from the mock sample.}
...
\begin{figure}
	...
	\caption{Best fit curves for void tracers with (right) and without (left) systematics. The model fits the mean curve well within the $1\sigma$ band (shaded region). We observe, however, that the model does not follow the mean curve as close as for the galaxy case, specially at larger scales.}
