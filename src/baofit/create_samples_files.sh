...
do
for tracer in ind_void_nowt_parabola_case${case_} #ind_void_nowt_parabola_case${case_}_dl individual_void_nowt_case${case_}_template individual_gal individual_gal_nowt ind_void_parabola_case${case_} 
do
