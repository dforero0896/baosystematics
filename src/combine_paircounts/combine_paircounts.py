...
try:
	...
	sys.exit(1)
RRfn = [f for f in filenames_RR if 'NGC' in f and f.replace('NGC', 'SGC') in filenames_RR]
DDfn = [f for f in filenames_DD if 'NGC' in f and f.replace('NGC', 'SGC') in filenames_DD]
