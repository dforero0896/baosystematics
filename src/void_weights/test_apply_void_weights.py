from apply_void_weights import edges_to_centers, get_known_void_weight, get_known_void_weight_matrix
from params import *
import xarray as xr
...
print(f"No ravel")
test_centers = get_known_void_weight_matrix(Rc, Xc, Yc, void_matrix)
