...
import pandas as pd
import numpy as np
def mask_with_function(data, comp_mesh, seed=2, noise=True, box_size=2500, N_grid=None, sigma_noise=0.3):
  np.random.seed(seed)
  if not N_grid:
