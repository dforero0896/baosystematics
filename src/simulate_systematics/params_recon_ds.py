...
handle = '' #string to identify the run; used to set filenames
handle_ran = 'ran'
...
f = 0.7432282059175079         # the linear growth rate at the mean redshift
rsd_corr = True # if False, no RSD correction is performed and niter should be 1. Use when supplying real-space catalogs.
...
tracer_file = 'tests/CATALPTCICz0.466G960S1005638091_zspace.dat'     # /path/to/file with input data
