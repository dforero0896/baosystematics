...
OUTPUT=$2
OVERWRITE=$3
if [[ ! -e $OUTPUT"../dicts" ]];then
	mkdir $OUTPUT"../dicts"
fi
python /home/epfl/dforero/zhao/void/baosystematics/src/merge_to_fits.py $INPUT $OUTPUT $SLURM_ARRAY_TASK_COUNT $SLURM_ARRAY_TASK_ID $OVERWRITE
