...
import glob
z=0.4656
before_file = glob.glob("/hpcstorage/dforero/projects/baosystematics/patchy_results/box1/redshift/nosyst/powspec_gal_mock_nowt/powspec_CATALPTCICz0.466G960S1005638091*")[0]
after_file = glob.glob("/home/astro/dforero/scratch/projects/baosystematics/patchy_recon/box1/redshift/nosyst/powspec_gal_mock_nowt/powspec_CATCATALPTCICz0.466G960S1005638091*")[0]
