...
handle = 'CATALPTCICz0.466G960S1005638091_zspace_wran_nopad'  # string to identify the run; used to set filenames
handle_ran = 'box_uniform_random_seed1_0-2500_nopad'
