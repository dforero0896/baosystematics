...
find patchy_results/ -wholename '*baofit/*/*multinest_map*' -size -3G | xargs -I '{}' cp -u -v {} --parents reports/ &
...
find patchy_recon_nods/ -name '*mockavg*' | xargs -I '{}' cp -u -v {} --parents reports/ &
